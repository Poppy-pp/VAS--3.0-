				...
				<template v-for="(item,index) in filters.domSearch">
					...
					<template v-if="index == 0">
						<el-form-item label="库管">
							<el-select v-model="filters.managerid" placeholder="请选择库管" @visible-change="empChangeSelect" clearable filterable>
							    <el-option v-for="item in managerOptions" :key="item.ID" :label="item.employeename + ' ('  + item.mobile + ')'" :value="item.ID"></el-option>
							</el-select>
						</el-form-item>
						<el-form-item>
			...
			<el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm">
				<el-row :gutter="20">
					<el-col :span="12">
						...
						<el-form-item label="上级库房" prop="parentid" v-if="this.addForm.storagelevel != 2">
