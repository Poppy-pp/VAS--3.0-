    ...
    <div class="invoice-detail">
        ...
        <el-form label-width="100px" ref="facilityForm" :model="facilityForm" :rules="facilityFormRules" v-if="facilityForm">
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item label="发货日期" prop="delivery.deliverydate" v-if="facilityForm.delivery.deliverytype != 2" key="2-1">
                        <el-date-picker
                                :disabled="isView"
                                value-format="yyyy-MM-dd"
                ...
                <el-col :span="12" v-if="facilityForm.delivery.deliverytype == 1" key="1">
                ...
                <el-col :span="12" v-if="facilityForm.delivery.deliverytype == 1" key="2">
                ...
                <el-col :span="12" v-if="facilityForm.delivery.deliverytype != 1" key="3">
                    <el-form-item label="车牌号" prop="delivery.vehicleplate" v-if="facilityForm.delivery.deliverytype != 2" key="2-2">
                ...
                <el-col :span="12" v-if="facilityForm.delivery.deliverytype != 1" key="4">
                    <el-form-item label="联系电话" prop="delivery.contactno" v-if="facilityForm.delivery.deliverytype != 2" key="2-3">
            ...
            <el-row>
                ...
                <el-button style="float: right; margin-left: 10px;" type="danger" v-if="!isView" @click="addPart()" :disabled="editable"><i
                        class="iconfont icon-zhibiao"></i> 添加配件
                </el-button>
                <el-button style="float: right; margin-left: 10px;" type="danger" v-if="!isView" @click="addFacility()" :disabled="editable"><i
