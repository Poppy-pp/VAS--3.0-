...
// 模糊查询
const getOwnerInfoListSelect = params => {
    return axios.get(`admin/ownerInfo/query/like`, {params: params});
};
// 详情
...
// 验证车主
const checkOwner = params => {
    return axios.get(`admin/ownerInfo/query/ownerIsExist`, {params:params})
};
// 验证车架号
