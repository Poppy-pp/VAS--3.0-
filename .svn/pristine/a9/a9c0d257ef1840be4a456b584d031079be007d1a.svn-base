...
export const getStoPurchaseList = params => {
    return axios.get(`/sto/stoPurchase/modelcategory/A`, {params: params})
};
// 入库批次
export const getPartsBatchno = params => {
    return axios.get(`/sto/qrcode/serialnumber/A`, {params: params})
};
