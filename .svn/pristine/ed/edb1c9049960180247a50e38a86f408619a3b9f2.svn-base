<template>
    <section class="tab_content-wrapper">
        ...
        <el-dialog title="编辑" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="100px" :rules="rules" ref="editForm" v-if="editFormVisible">
                <el-row :gutter="20">
                    <el-col :span="12">
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item label="编辑员工" prop="tempEmps">
                            <el-select v-model="editForm.tempEmps" multiple remote
                ...
                <el-row :gutter="20">
                    ...
                    <el-col :span="12">
                        ...
                        <el-form-item label="新增员工" prop="emps">
                            <el-select v-model="addForm.emps" @visible-change="employChange" filterable multiple placeholder="请选择"
                                       clearable remote>
                                <el-option v-for="item in employlist" :key="item.ID" :label="item.employeename" :value="item.ID">
                                </el-option>
                            </el-select>
