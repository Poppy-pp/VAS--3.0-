<template>
	<section class="tab_content-wrapper">
						...
						<div style="display:inline-block;margin:0 10px 10px 0;">
							<el-input class="noborder color icon nofocus" @keyup.native.ctrl.8="clearAll()" @keyup.native.13="handleQuery" placeholder="请输入查询内容" v-model="filters.domSearch[index].content">
								<el-select class="wp_select" multiple clearable filterable v-model="filters.domSearch[index].select" slot="prepend" placeholder="选择条件">
									...
									<el-option label="经办人" value="createbyname"></el-option>
								</el-select>
		...
		<el-table :max-height="windowOutHeight-215" border :data="listData" highlight-current-row v-loading="listLoading">
			...
			<el-table-column prop="purchasedate" label="采购日期" :formatter="dateFormatterOne" align="center" width="100">
			</el-table-column>
			...
			<el-table-column prop="createbyname" label="经办人" align="center" >
			</el-table-column>
			<el-table-column label="入库量" align="center" width="80">
			...
			<el-table-column prop="stocknum" label="收货量" align="center" width="80">
			</el-table-column>
					...
					<el-row :gutter="10">
						...
						<el-col :span="12">
							...
							<el-form-item label="供应商：" >
								<span>{{ contractThisList.suppliername == null ? "--" :contractThisList.suppliername }}</span>
							</el-form-item>
							<el-form-item label="联系人：" >
								<span>{{ contractThisList.linkman == null ? "--" :contractThisList.linkman }}</span>
							</el-form-item>
						</el-col>
						<el-col :span="12">
							<el-form-item label="采购数量(总)">
								<span class="quantity">{{ contractThisList.purchaseqty }}</span>
							</el-form-item>
							<el-form-item label="合同名称：" >
								<span>{{ contractThisList.contractname == null ? "--" : contractThisList.contractname }}</span>
							</el-form-item>
							<el-form-item label="经办人：">
								<span>{{ contractThisList.createbyname == null ? "--" : contractThisList.createbyname }}</span>
							</el-form-item>
							<el-form-item label="联系方式：" >
								<span>{{ contractThisList.contactno == null ? "--" : contractThisList.contactno }}</span>
							</el-form-item>
						</el-col>
					</el-row>
					<el-row :gutter="10">
					...
					<el-row :gutter="10">
						...
						<el-table border :data="typeListData" ref="typeForm" max-height="800" v-loading="typeListLoading">
							...
							<el-table-column label="采购型号" align="center">
								<template slot-scope="scope">
									...
									<el-form-item prop="modelname" :rules="{required: true, message: '采购型号不能为空', trigger: 'blur'}">
							    		    <el-cascader @focus="modelCascader" @change="handleChange" :options="modelOptions" v-model="typeForm.modelname" ref="cascader" clearable></el-cascader>
							    		</el-form-item>
							    	    </div>
							...
							<el-table-column label="删除" align="center" width="50">
								<template scope="scope">
									<el-button v-if="!editable" id="button"  @click="handleDel(scope.$index, scope.row)" title="删除"> <i class="iconfont icon-p-delet  operate operate-delet"></i></el-button>
								</template>
							</el-table-column>
						</el-table>
					</el-form>
		...
		<el-dialog title="入库单详情" :modal-append-to-body="false" :visible.sync="deviceFormVisible">
			<el-col :span="24" class="toolbar">
				<el-form :inline="true" :model="filtersSto">
					<div style="display:inline-block;margin:0 10px 10px 0;">
						<el-input class="noborder color icon nofocus" @keyup.native.ctrl.8="clearAll()" @keyup.native.13="getDeciceListInfo" placeholder="请输入查询内容" v-model="filtersSto.domSearch[0].content">
							<el-select class="wp_select" multiple clearable filterable v-model="filtersSto.domSearch[0].select" slot="prepend" placeholder="选择条件">
			...
			<el-table border :data="deviceListData" max-height="500" v-loading="devicelistLoading" >
				<el-table-column type="index" width="30" align="center" label="#"></el-table-column>
				<el-table-column prop="batchno" label="入库单号/批次" align="center" width="130"></el-table-column>
				<el-table-column prop="instockdate" label="入库日期" align="center" :formatter="dateFormatter" width="140"></el-table-column>
				<el-table-column prop="storagename" label="入库库房" align="center" width="80"></el-table-column>
				...
				<el-table-column prop="instockmodels" label="入库详情" align="center"></el-table-column>			
			</el-table>
			<!--工具条-->
			<el-col :span="24" class="toolbar">
...
.quantity{font-size: 18px;font-weight: bold;}
