...
<template>
  <div class="sidebar-wrap">
    <div class="left-area">
      <img class="el-header__icon" src="../../assets/images/logo.png" width="36px" height="36px" alt="万网鑫成科技">
      <span class="el-header__title">
        VAS<span class="subtitle">车联网</span>
    ...
    <div class="middle-area">
      <div class="middle-area__cgwrap" @click="handleSwitchNavbar">
          <i class="iconfont icon-home" title="折叠菜单"></i>
      </div>
