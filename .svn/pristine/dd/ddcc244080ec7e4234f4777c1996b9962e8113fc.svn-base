...
<template>
	<section class="tab_content-wrapper">
		...
		<el-table :max-height="windowOutHeight-215" border :data="listData" :row-class-name="tableRowClassName" highlight-current-row v-loading="listLoading" style="width: 100%;" @sort-change="sortChange">
			...
			<el-table-column prop="yeartomarket" label="年款" align="center" :formatter="dateFormatterThird" width="60" >
			</el-table-column>
			<el-table-column prop="firstcategory" label="首字母" align="center" width="70" >
			</el-table-column>
		...
		<!-- 详情 弹窗 start-->
		<el-dialog title="车型详情" :modal-append-to-body="false" :visible.sync="formDialogTableVisible">
			<el-tabs>
				<el-row>
					<el-col :span="24">
