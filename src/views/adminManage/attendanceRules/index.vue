<template>
	<section class="tab_content-wrapper">
		...
		<el-table :max-height="windowOutHeight-215" border :data="listData" highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="width: 100%;">
			...
			<el-table-column prop="standardintime" label="签到标准时间" align="center">
				<template slot-scope="scope">
                    <el-tag type="success">{{scope.row.standardintime}}
                    </el-tag>
                </template>
			</el-table-column>
			<el-table-column prop="standardouttime" label="签退标准时间" align="center">
				<template slot-scope="scope">
                    <el-tag type="success">{{scope.row.standardouttime}}
                    </el-tag>
                </template>
			</el-table-column>
		...
		<el-dialog title="编辑" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
			<el-form :model="editForm" label-width="110px" :rules="editFormRules" ref="editForm" v-if="editFormVisible">
				<el-row :gutter="20">
					<el-col :span="12">
						...
						<el-form-item label="员工级别" prop="emplevel">
							<el-input v-model="editForm.emplevel" auto-complete="off" placeholder="请输入员工级别"></el-input>
						</el-form-item>
					...
					<el-col :span="12">
						...
						<el-form-item label="所属中心区域" prop="attendcentername">
							<el-select v-model="editForm.attendcentername" @visible-change="attendcenterChange" :loading="attendcenterLoading" filterable placeholder="请选择所属中心区域" clearable>
								<el-option v-for="item in attendcenterlist" :key="item.attendcentername" :label="item.attendcentername" v-if='item.attendcentername' :value="item.id">
								</el-option>
							</el-select>
						</el-form-item>
						<el-form-item label="考勤区域范围(半径N米)" prop="attendparam">
							<el-input v-model="editForm.attendparam" auto-complete="off" placeholder="请输入考勤区域范围"></el-input>
						</el-form-item>
			...
			<el-form :model="addForm" label-width="110px" :rules="addFormRules" ref="addForm" v-if="addFormVisible">
				<el-row :gutter="20">
					<el-col :span="12">
						...
						<el-form-item label="员工级别" prop="emplevel">
							<el-input v-model="addForm.emplevel" auto-complete="off" placeholder="请输入员工级别"></el-input>
						</el-form-item>
						<el-form-item label="签到标准时间" prop="standardintime">
					...
					<el-col :span="12">
						<el-form-item label="缓冲时间(分)" prop="buffertime">
							<el-input v-model="addForm.buffertime" auto-complete="off" placeholder="请输入缓冲时间"></el-input>
						</el-form-item>
						<el-form-item label="所属中心区域" prop="attendcentername">
						...
						<el-form-item label="考勤区域范围(半径N米)" prop="attendparam">
							<el-input v-model="addForm.attendparam" auto-complete="off" placeholder="请输入考勤区域范围"></el-input>
						</el-form-item>
						<el-form-item label="备注" prop="remarks">
