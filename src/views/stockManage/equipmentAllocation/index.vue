<template>
	<section class="tab_content-wrapper">
		...
		<!-- 遗失 弹窗 -->
		<el-dialog title="遗失操作" :modal-append-to-body="false" :close-on-click-modal='false' :visible.sync="loseFormVisible">
		            <el-tabs v-model="activeName" @tab-click="handleClick" type="card">
						...
						<el-row :gutter="10">
							...
							<el-col :span="12">
								...
								<el-form-item label="遗失人：" prop="lostuser">
									<el-select v-model="loseForm.lostuser" @visible-change="loseEmpChange" @change="chooseLoseEmp" :loading="loseEmpLoading" filterable placeholder="请选择遗失人" clearable value-key="employeename">
										<el-option v-for="item in loseEmplist" :key="item.name" :label="item.employeename + '-' + item.mobile" :value="item"></el-option>
									</el-select>
								</el-form-item>
							</el-col>
							<el-col :span="12" v-if="loseForm.lostuser != ''">
								<el-form-item label="库房：" prop="storagename">
							                        <el-select v-model="loseForm.storagename" @visible-change="stoChange" @change="chooseStorage" filterable clearable placeholder="请选择库房" value-key="storagename">
						...
						<template slot-scope="scope">
						        <el-popover placement="right" @show="getLostDetails(scope.row)" width="700">
