...
export const getStoList = params => {
    return axios.get(`/sto/stoStorage/manager/` + params.id)
};
// 新增遗失
...
export const updatePurchaseQty = params => {
    return axios.put('sto/stoRequest/mod/updateTransferPurchaseqty', params)
}
// 新增——查询所有已选设备
...
export const getEmployeeInfoList = params => {
    return axios.get(`/sto/allocation/lost/users` )
};
