    ...
    <div class="invoice-detail">
        ...
        <el-form label-width="100px" ref="facilityForm" :model="facilityForm" :rules="facilityFormRules" v-if="facilityForm">
            ...
            <el-row>
                ...
                <el-col :span="12" v-if="isProcurement">
                ...
                <el-col :span="12">
                    <el-form-item label="供应商" prop="suppliername">
                        <el-select filterable placeholder="请选择供应商" v-model="facilityForm.suppliername" @focus="getSupplierList" :disabled="isProcurement || isView"
                ...
                <!--<el-col :span="12">-->
                    <!--<el-form-item label="供应商" prop="suppliername">-->
                        <!--<el-input placeholder="请选择供应商" v-model="facilityForm.suppliername" :disabled="isProcurement || isView"></el-input>-->
                    <!--</el-form-item>-->
                <!--</el-col>-->
                <el-col :span="12">
                    <el-form-item :label="isProcurement?'采购日期':'返厂日期'" prop="purchaseDate">
                        <el-date-picker
