...
<template>
    <section class="tab_content-wrapper">
                        ...
                        <div style="display:inline-block;margin:0 10px 10px 0;">
                            <el-input class="noborder color icon nofocus" @keyup.native.ctrl.8="clearAll()" @keyup.native.13="handleQuerySelect" placeholder="请输入查询内容" v-model="filters.domSearch[index].content">
                                <el-select class="wp_select" multiple clearable filterable v-model="filters.domSearch[index].select" slot="prepend" placeholder="选择条件">
                                    ...
                                    <el-option label="类别" value="suppliertypename"></el-option>
        ...
        <el-table :max-height="windowOutHeight-275"  border :data="listData" :row-class-name="tableRowClassName" highlight-current-row v-loading="listLoading">
            ...
            <el-table-column prop="suppliertypename" label="类别" align="center"  width="120">
            </el-table-column>
            <el-table-column prop="supplierlevel" label="级别" align="center" width="60">
            </el-table-column>
            <el-table-column prop="linkman" label="联络人" align="center"  width="90">
            </el-table-column>
                ...
                <el-tab-pane label="基础信息" name="first">
                    ...
                    <el-row>
                        ...
                        <el-col :span="5">
                            <dl class="dllist" style="margin-bottom:10px;">
                                <dt>创建人:</dt>
                                <dd>{{supplierThisList.createbyname == undefined ? '--' : supplierThisList.createbyname}}</dd>
                            </dl>
                        </el-col>
                        <el-col :span="7">
                            <dl class="dllist" style="margin-bottom:10px;">
                        ...
                        <el-col :span="5">
                            <dl class="dllist" style="margin-bottom:10px;">
                                <dt>修改人:</dt>
                                <dd>{{supplierThisList.updatebyname == undefined ? '--' : supplierThisList.updatebyname}}</dd>
                            </dl>
                        </el-col>
                        <el-col :span="7">
                            <dl class="dllist" style="margin-bottom:10px;">
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        ...
                        <el-form-item label="类别" prop="suppliertype">
                            <el-select v-model="editForm.suppliertypename" @visible-change="supplierTypeChange" :loading="supplierTypeLoading" filterable placeholder="请选择供应商类别" @change="chooseType" clearable>
