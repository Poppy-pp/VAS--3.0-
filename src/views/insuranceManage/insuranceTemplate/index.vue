<template>
    <section class="tab_content-wrapper">
        ...
        <el-table border :max-height="windowOutHeight-215" :data="listData" highlight-current-row v-loading="loading"
            ...
            <!--<el-table-column prop="policyno" align="center" label="保单号">-->
            <!--</el-table-column>-->
        ...
        <el-dialog :title="form.id?'编辑':'新增'" :modal-append-to-body="false" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="form" label-width="110px" :rules="rules" ref="form" v-if="addFormVisible">
                ...
                <el-form-item label="对应保险公司" prop="insucorpid">
                    <el-select v-model="form.insucorpname" placeholder="请选择保单模板对应的保险公司" @change="changeInsucorp" :disabled="Boolean(form.id)">
                        <el-option
                                v-for="item in insuCorpList"
                                :key="item.id"
                                :label="item.corpname"
                                :value="item.id">
                        </el-option>
                ...
                <!--<el-form-item label="保单编号">-->
                    <!--<el-input v-model="form.policyno" auto-complete="off" disabled></el-input>-->
                <!--</el-form-item>-->
                <!--<el-form-item label="有效日期">-->
                    ...
                    <!--</el-date-picker>-->
                    <!--&lt;!&ndash;<el-input v-model="form.insucorpeffectivedate" auto-complete="off" disabled></el-input>&ndash;&gt;-->
                <!--</el-form-item>-->
