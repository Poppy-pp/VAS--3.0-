...
import { getInsuranceDataCount } from "../insuranceCount/service";
import { checkFloatNum } from '@/utils/formValidation'
...
export default {
    ...
    methods: {
        ...
        checkFloatNum (value) {
            if (/^\d+$/.test(value)) {
                this.addPremiumForm.addPolicyPremium = value + '.00'
            }
        },
        isJump (page) {
