<template>
    <section class="tab_content-wrapper">
                        ...
                        <div style="display:inline-block;margin:0 10px 10px 0;">
                            <el-input class="noborder color icon nofocus" @keyup.native.ctrl.8="clearAll()" @keyup.native.13="handleQuerySelectFn"
                                ...
                                <el-select class="wp_select" multiple clearable filterable v-model="filters.domSearch[index].select" slot="prepend"
                                    ...
                                    <el-option label="OA账号" value="username"></el-option>
        ...
        <el-table :max-height="windowOutHeight-220" border :data="listData" :row-class-name="isenableFomat" highlight-current-row
            ...
            <el-table-column prop="username" label="OA账号" align="center" width="130">
            </el-table-column>
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        ...
                        <el-form-item label="手机号码" prop="mobile" ref="mobile" :error="mobileErrMessage">
                            <el-input v-model="editForm.mobile" placeholder="请输入员工手机号码" auto-complete="off" @blur="checkEditMobile(editForm.mobile)"></el-input>
                        </el-form-item>
                        <el-form-item label="OA账号" prop="username" :error="usernameErrMessage">
                            <el-input v-model="editForm.username" placeholder="请输入员工用户名" auto-complete="off" @blur="checkEditUsername(editForm.username)"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
            ...
            <el-form :model="addForm" label-width="100px" :rules="addFormRules" ref="addForm" v-if="addFormVisible">
                <el-row :gutter="20">
                    <el-col :span="12">
                        ...
                        <el-form-item label="手机号码" prop="mobile" ref="mobile" :error="mobileErrMessage">
                            <el-input v-model="addForm.mobile" placeholder="请输入员工手机号码" auto-complete="off" @blur="checkMobile(addForm.mobile)"></el-input>
                        </el-form-item>
                        <el-form-item label="OA账号" prop="username" :error="usernameErrMessage">
                            <el-input v-model="addForm.username" placeholder="请输入员工OA账号" auto-complete="off" @blur="checkUsername(addForm.username)"></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="所属公司" prop="corpname">
                        ...
                        <el-form-item label="员工岗位" prop="positionname">
                            <el-select v-model="addForm.positioncode" @visible-change="posChange" :loading="posLoading" filterable placeholder="请选择员工岗位" @change="changePosition"
                                       clearable remote>
                                <el-option v-for="item in poslist" :key="item.id" :label="item.dictdatavalue" :value="item.dictdataname">
                                </el-option>
                            </el-select>
