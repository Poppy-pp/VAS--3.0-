    ...
    <section class="tab_content-wrapper">
		...
		<el-table :max-height="windowOutHeight-215" border :data="listData" :row-class-name="tableRowClassName" highlight-current-row v-loading="listLoading" style="width: 100%;" @sort-change="sortChange">
			<el-table-column type="index" width="30" align="center" label="#">
             ...
             <el-table-column prop="currentState" label="设备离线情况" align="center" width="340">
            ...
            <el-table-column prop="equipmentTime" label="离线触发时间" align="center" width="155">
            </el-table-column>
            <el-table-column prop="equipmentInfo" label="设备信息" align="center" width="155">
			</el-table-column>
			...
			<el-table-column prop="LatestProcessingDetails" label="最新处理详情" align="center">
                <template slot-scope="scope">
                    <el-popover trigger="hover" placement="bottom">
