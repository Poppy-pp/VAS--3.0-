        ...
        <el-row>
            <el-col :span="24" class="cbstyle">
                ...
                <el-collapse class="bdcoll rpShowimgDialog" ref="rpShowimgDialog" v-model="activeNames">
                    ...
                    <el-collapse-item v-if="vehicleInfo" title="选择设备" class="lefw10 wzpdt10" name="3">
                        <ul v-if="installDetails.length">
                            <li v-for="(val, index) in installDetails">
                                <el-checkbox v-if="!val.newDeclaration || val.newDeclaration.status === '6'" v-model="val.checked" style="width: 150px;">
