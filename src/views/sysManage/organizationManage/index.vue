                ...
                <el-card>
                    ...
                    <h2 class="form-title">
                        <span v-if="formStatus === 'create'">
                            {{`为 ${currentData.corpname} 添加公司`}}
                        </span>
                        <span v-else>
                            {{currentData?currentData.corpname:''}}
                        </span>
                    </h2>
                    <organization :formEdit="formEdit" :formStatus="formStatus" @onCancel="onCancel" :data="currentData" @update="update"
                                  @create="create"></organization>
                </el-card>
                <el-card style="margin-top: 10px;" v-if="this.currentData && this.currentData.id == 1">
