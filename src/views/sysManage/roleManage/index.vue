    ...
    <section class="tab_content-wrapper">
        ...
        <el-col :span="24" class="toolbar">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.roleName" @keyup.native.enter="handleQuerySelect" placeholder="请输入角色名称"></el-input>
            ...
            <el-col :span="24">
                ...
                <el-col :span="24">
                    <el-tree v-loading="treeRouseLoading" element-loading-text="VAS列表加载中..." element-loading-spinner="el-icon-loading"
                             element-loading-background="rgba(0, 0, 0, 0.7)" :props="defaultProps" highlight-current node-key="id"
                             :default-expanded-keys="defaultExpandedKeys" :default-checked-keys="defaultCheckedKeys" ref="treeRouse" :check-strictly="true"
                              @check-change="handleCheckChange"  :data="regions" show-checkbox>
                             <span class="custom-tree-node" slot-scope="{ node, data }">
                                    <span>{{ node.label }}</span>
                                    <span style="flex: 1;">
                                        <el-tag style="float: right; margin-top: 4px" type="danger" v-if="data.type === '1'" size="mini">按钮</el-tag>
        ...
        <el-dialog title="编辑角色" :modal-append-to-body="false" :visible.sync="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
                ...
                <el-form-item label="角色值" prop="roleCode">
                    <el-input v-model="editForm.roleCode" auto-complete="off" placeholder="请输入角色值" disabled></el-input>
                </el-form-item>
