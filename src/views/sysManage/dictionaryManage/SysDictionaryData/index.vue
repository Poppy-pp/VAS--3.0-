    ...
    <section class="tab_content-wrapper">
        ...
        <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
            <el-form :inline="true" :model="filters">
                <el-form-item>
                    <el-input v-model="filters.model" @keyup.native.enter="handleQueryFn" placeholder="请输入关键字"></el-input>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" icon="el-icon-search" @click="handleQueryFn">查询</el-button>
                </el-form-item>
                <el-form-item>
        ...
        <el-dialog title="新增" :modal-append-to-body="false" :visible.sync="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="80px" :rules="editFormRules" ref="addForm" v-if="addFormVisible">
                <el-form-item label="字典值" prop="dictvalue">
